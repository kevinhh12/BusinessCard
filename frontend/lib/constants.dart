...
const Color knavBarItemBackgroundColor = Colors.white;
const String kTemplateBackground_1 =
    'https://www.solidbackgrounds.com/images/2048x1536/2048x1536-caput-mortuum-solid-color-background.jpg';
const String kTemplateImage_1 =
    'https://w0.peakpx.com/wallpaper/37/342/HD-wallpaper-music-aespa-karina-singer.jpg';

final List<BusinessCardModel> kcardExample = [
  BusinessCardModel(
    name: 'Karina',
    title: 'Aespa Captain',
  ...
  BusinessCardModel(
    name: 'Lionel Messi',
    title: 'World Champion Footballer',
